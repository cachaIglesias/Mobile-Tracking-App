...
public class TrackingServiceConnector {
    ...
    public void obtenerEntregaActiva(Integer deliveryManID, MapsActivityState mapsActivityState){
...
//        Float metros = Float.valueOf(getSharedPref().getString("minDist", "10").split(" ")[0]);
        ...
        OrderTrackingServiceObserver orderObserver = new OrderTrackingServiceObserver(mapsActivityState, geofenceTransitionService);
